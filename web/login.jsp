                        ...
                        <form action="Controller" method="post">
                            ...
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="Nhập username" id="username" name="txtUserName" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Password</label>
                                    <div class="controls">
                                        <input type="password" placeholder="Nhập password" id="password" name="txtPassWord" class="input-xlarge">
                                    </div>
                                </div>
                                
                                <div>
                                    <p><font color="red"> ${sessionScope.FailLogin}</font></p>
                                </div>
                                <div class="control-group">
                                    <input tabindex="3" class="btn btn-inverse large" type="submit" value="Log In" name="action">
                                    <p>Bạn chưa có tài khoản? Click vào <a href="register.jsp">đây</a> để đăng ký.</p>
