            ...
            <div class="row">
                <div class="span4">
                    <form action="Controller" method="POST" >
                        <input type="text"  Placeholder="eg. T-sirt" name="txtSearch">
                ...
                <div class="row">
                    <div class="span12">													
                        <div class="row">
                            <div class="span12">
                                <h4 class="title">
                                    <span class="pull-left"><span class="text"><span class="line">Sản phẩm <strong>đặc biệt</strong></span></span></span>
                                            ...
                                            <ul class="thumbnails">
                                                ...
                                                <%
                                                    ...
                                                    for (Product sp : list) {
                                                        ...
                                                        out.print("<form action='CartController' method='post'");
